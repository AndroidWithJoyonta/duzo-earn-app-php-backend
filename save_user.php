...
$sql = "INSERT INTO users (name, email, referral_code, earn) 
        VALUES ('$name', '$email', '$referral_code', '$new_user_earn') 
...
if ($conn->query($sql) === TRUE) {
    ...
    if ($referrer_earn > 0) {
        $sql_update_referrer = "UPDATE users SET earn = $referrer_earn WHERE id = $new_user_earn";
